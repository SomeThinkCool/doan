...
$keyword = 'văn phòng'; // Tìm kiếm sản phẩm có "văn phòng" trong tên
...
<head>
    <meta charset="UTF-8">
    <title>PC Văn Phòng | PC Store</title>
...
<div class="main-body">
    ...
    <?php else: ?>
        <p>Không tìm thấy sản phẩm PC Văn Phòng nào.</p>
    <?php endif; ?>
</div>
