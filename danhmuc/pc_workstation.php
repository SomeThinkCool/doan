<?php
include('../db_connect.php'); // chỉnh lại đường dẫn nếu khác
...
<head>
    <meta charset="UTF-8">
    <title>PC Workstation | PC Store</title>
...
<div class="main-body">
    <h2>Danh sách PC Workstation</h2>
    ...
    <?php else: ?>
        <p>Không tìm thấy sản phẩm Workstation nào.</p>
    <?php endif; ?>
</div>
