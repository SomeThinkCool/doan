...
$keyword = 'Core Ultra'; // Tìm kiếm sản phẩm có "Core Ultra" trong tên
...
// $products chứa kết quả tìm kiếm dưới dạng mảng liên kết
?>
...
<head>
    <meta charset="UTF-8">
    <title>PC Core Ultra | PC Store</title>
...
<div class="main-body">
    ...
    <?php else: ?>
        <p>Không tìm thấy sản phẩm PC Core Ultra nào.</p>
    <?php endif; ?>
</div>
