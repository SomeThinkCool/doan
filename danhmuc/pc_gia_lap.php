...
$keyword = 'PC Giả Lập'; // Tìm kiếm sản phẩm có "PC Giả Lập" trong tên
...
<head>
    <meta charset="UTF-8">
    <title>PC Giả Lập | PC Store</title>
...
<div class="main-body">
    ...
    <?php else: ?>
        <p>Không tìm thấy sản phẩm PC Giả Lập nào.</p>
    <?php endif; ?>
</div>
